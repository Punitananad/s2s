...
# Guest summary (orders & services combined)
    path("h/<int:hotel_id>/r/<int:room_id>/summary/", views.guest_summary, name="guest_summary"),

    path("cart/mini/", views.cart_mini, name="cart_mini"),

    path("h/<int:hotel_id>/r/<int:room_id>/verify/", views.verify_phone, name="verify_phone"),
    path("h/<int:hotel_id>/r/<int:room_id>/<int:request_id>/",views.request_tracking,name="request_tracking"),
